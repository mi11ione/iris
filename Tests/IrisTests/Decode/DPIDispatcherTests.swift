...
/// Validates DPI dispatch through the public surface.
...
/// Validates that the standard composition routes op0 {0x8, 0x9} to DPI,
/// asserted through public category attribution.
